...
const EnrollmentGraph = () => {
  ...
  return (
    ...
    >
      ...
      >
        <SubHeading>Total Enrollment of Student & Agent</SubHeading>
        <Box
          sx={{
            display: "flex",
            flexDirection: "row",
        ...
        >
          <GraphLegend color="#F5CB77" title="Students Registration" />
          <GraphLegend color="#76C8E1" title="Agents Registration" />
